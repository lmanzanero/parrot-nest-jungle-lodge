        ...
        return (
            <div className="about">
                ...
                <Parallax imageSrc="/images/gallery/14.jpg"/>
                    ...
                    <h1 className="header center teal-text text-lighten-2">Jungle Paradise</h1>
                        ...
                        <div className="col s12 m4 l4">
                            ...
                            <div className="row center">
                            <p className="header">Parrot Nest is an ideal home base for your explorations of this fascinating district with its rivers (including falls and cascades), caves, archeological sites, jungle walks, medicine trails, butterfly farms and many more attractions. High adventure at a low price is our motto here, and peaceful relaxation is provided free of charge.	</p>
                            </div>
                            <br></br>
                        </div>
                        <div className="col s12 m4 l4">
                ...
                <div className="row about-buttons">
                    <div className="col s12 m4 l4 about-buttons">
                        <Link to="/tours"   className="btn-large waves-effect waves-light teal lighten-1">For a list of tours, including our free tubing adventure, just click here</Link>
                    </div>
                    <div className="col s12 m4 l4 about-buttons">
